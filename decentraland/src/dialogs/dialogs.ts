...
export let RobozinDialog: Dialog[] = [
  {
    text: 'Olá, eu sou o Robozin! Sou um robô que adora ajudar as pessoas a aprenderem sobre tecnologia e inovação.',
    isQuestion: true,
    buttons: [
      {
      ...
      {
        label: 'Quais são suas habilidades?', // Changed from "Quais são suas habilidades?" to "Quais são suas habilidades?"q --- IGNORE ---
        goToDialog: 2
      }
    ]
  }           
